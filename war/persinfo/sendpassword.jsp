	...
	<div class="section">
		<div class="box big">
			...
			<div class="content forms thankyoupage">
				...
				<p>We have sent the password to your email at <a href='mailto:<s:property value="%{email}" />'><s:property value="%{email}" /></a>, Please check it to continue your access to PteCloud. </p>
